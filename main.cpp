...
int main(void)
{
    DivisonOfBank unit1(1, "Jan Kowalski", "Warszawa", 1000.1, 10, 20.1);
    DivisonOfBank *unit2; // meant for demostration of dynamic allocation and dislocation
    unit2 = new DivisonOfBank(1, "medrek", "Otwock", 100, 2, 23);
    checkAllMethodsInDivision(unit1);
    cout << endl
         << "============================" << endl;
    checkAllMethodsInDivision(*unit2);
    delete unit2;
    return 0;
}